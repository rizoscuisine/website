...
export default function ReviewSlider({ reviewData }: Readonly<ReviewSliderProps>) {
	...
	return (
		<div className="relative w-11/12 m-auto">
			...
			{/* Left arrow button */}
			<button
				onClick={() => setCurrentIndex((prevIndex) => (prevIndex - 1 + reviewData.length) % reviewData.length)}
